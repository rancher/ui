...
- Upload `./dist/static/release-2.7` so that it's available at https://your-server.com/release-2.7
  - It must be available over HTTPS.
  - You can rename the "release-2.7" part with the `-v` flag
- Change the value of https://your-rancher/v3/settings/ui-index to the same `https://your-server.com/release-2.7` URL
