...
const ALLOWED = {
  ...
  'api.allow.client.override': {description: 'Allow client IP to be overridden with X-Forwarded-For header', kind: 'boolean'},
  ...
  'api.proxy.allow': {description: 'Whitelist of domains to that can be proxied through /v1/proxy to, for custom Add Host UIs'},
  ...
  'graphite.host': {description: 'Graphite: Server hostname/IP'},
  ...
  'no.proxy': {description: 'Domains that should not use HTTP proxy (comma-separated)'},
