...
//    return
//      C.ACTIVEISH_STATES.indexOf(this.get('resource.state')) >= 0 &&
//      this.get('resource.healthState') !== 'started-once' &&
//      this.get('resource').hasLink(this.get('linkName'))
//  }.property('resource.{state,healthState,links}','linkName'),
