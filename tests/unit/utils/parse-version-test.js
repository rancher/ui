...
import { parse, stableMinor } from 'ui/utils/parse-version';
...
var data = [
  ...
  {str: 'v1.1.0-pre1',              parsed: ['1','1','0','pre1'],       minor: 'v1.0'},
  {str: 'v1.2.0-pre1',              parsed: ['1','2','0','pre1'],       minor: 'v1.1'},
  {str: 'v1.2.1-pre1',              parsed: ['1','2','1','pre1'],       minor: 'v1.2'},
  {str: 'v1.2.0-pre2',              parsed: ['1','2','0','pre2'],       minor: 'v1.1'},
  {str: 'v1.2.0-pre2-rc1',          parsed: ['1','2','0','pre2','rc1'], minor: 'v1.1'},
...
data.forEach(function(obj) {
  ...
  test('it can stableMinor: ' + obj.str, function(assert) {
    var expected = obj.minor;
    var actual = stableMinor(input);
    assert.strictEqual(actual, expected, 'Stables are minored correctly');
  });
});
