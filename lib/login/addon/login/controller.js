...
const USER_PASS_PROVIDERS = ['local', 'activedirectory', 'sambabox', 'openldap', 'freeipa'];
...
export default Controller.extend({
  ...
  isActiveDirectory: computed('access.{provider,providers}', function() {
    return !!get(this, 'access.providers').findBy('id', 'activedirectory');
  }),

  isSambaBox: computed('access.{provider,providers}', function() {
    return !!get(this, 'access.providers').findBy('id', 'sambabox');
  }),

  isOpenLdap: computed('access.{provider,providers}',  function() {
    return !!get(this, 'access.providers').findBy('id', 'openldap');
  }),

  isFreeIpa: computed('access.{provider,providers}',  function() {
  ...
  isAzureAd: computed('access.{provider,providers}', function() {
    return !!get(this, 'access.providers').findBy('id', 'azuread');
  }),

  isShibboleth: computed('access.{provider,providers}', function() {
  ...
  infoMsg: computed('errorCode', 'errorMsg', 'intl.locale', 'isForbidden', function() {
