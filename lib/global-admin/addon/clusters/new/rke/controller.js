  ...
  willSave() {
    ...
    if ( createNodes) {
      if ( !get(this, 'etcdSafe') ) {
        errors.push(intl.t('clustersPage.addPage.rke.new.errors.etcd'));
      }

      if ( !get(this, 'cpSafe') ) {
        errors.push(intl.t('clustersPage.addPage.rke.new.errors.controlplane'));
      }

      if ( !get(this, 'workerSafe') ) {
        errors.push(intl.t('clustersPage.addPage.rke.new.errors.worker'));
      }
    }
