...
import { get, computed, set, observer, setProperties } from "@ember/object";
...
export default Controller.extend({
  ...
  //     // this.transitionToRoute("clusters.new.launch", provider);
  //   },
  //   launchProvider() {
  //     this.transitionToRoute("clusters.new.launch", provider);
  //   }
  ...
  providerChoices: computed(
    ...
    function() {
      ...
      get(this, "model.nodeDrivers")
        ...
        .sortBy("name")
        .forEach(driver => {
          const { name, hasUi, hasBuiltinIconOnly: hasIcon, uiUrl } = driver;
