...
export default Controller.extend({
  ...
  drivers: computed(function() {
    return [
      ...
      // {route: 'security.authentication.ping',            label: 'Ping',              css: 'ping',            available:  this.hasRecord('githubconfig')  },
      // {route: 'security.authentication.freeipa',         label: 'FreeIPA',           css: 'freeipa',         available:  this.hasRecord('githubconfig')  },
