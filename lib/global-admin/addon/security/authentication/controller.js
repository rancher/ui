...
export default Controller.extend({
  ...
  drivers: computed(function() {
    return [
      ...
      {route: 'security.authentication.azure',           label: 'Azure AD',          css: 'azuread',         available: this.hasRecord('azureadconfig')  },
      ...
      {route: 'security.authentication.freeipa',         label: 'FreeIPA',           css: 'freeipa',         available: this.hasRecord('freeipaconfig')  },
