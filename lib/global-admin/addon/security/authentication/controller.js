...
export default Controller.extend({
  ...
  drivers:   computed(function() {
    return [
      ...
      {
        route:        'security.authentication.shibboleth',
        label:        'Shibboleth',
        css:          'shibboleth',
        available:    this.hasRecord('shibbolethconfig'),
        providerType: 'saml',
      },
      {
      ...
      {
        route:        'security.authentication.oidc',
        label:        'OIDC via Keycloak',
        css:          'oidc-keycloak',
        available:    this.hasRecord('oidcconfig'),
        providerType: null,
      },
    ];
  }),
