...
export default Controller.extend(AuthMixin, {
  ...
  actions: {
    ...
    updateEndpoints() {
      this.get('modalService').toggleModal('modal-update-azuread', {
        azureAd: get(this, 'azureAd'),
        model:      get(this, 'authConfig')
      });
    }
  ...
  needsEndpointUpdate: computed('authConfig.annotations', 'isEnabled', function() {
    return (get(this, 'isEnabled')  && (get(this, 'authConfig.annotations') || {})[C.AZURE_AD.ANNOTATION_MIGRATED]  !== 'true')
  }),
