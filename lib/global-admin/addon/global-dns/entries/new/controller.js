...
export default Controller.extend(ViewNewEdit, {
  ...
  providers: computed('model.providers.[]', 'primaryResource', function() {
  ...
  multiClusterApps: computed('model.multiClusterApps.[]', 'primaryResource', function() {
  ...
  projectTargets: computed('combinedProjectIds.[]', 'model.allProjects', 'projectsToRemoveOnUpgrade.[]', function() {
