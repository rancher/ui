...
export default Component.extend(ClusterDriver, {
  ...
  actions: {
    ...
    addNodeTemplate() {
      get(this,'modalService').toggleModal('modal-edit-node-template', null, get(this, 'nodeWhich'));
    },
  },
  ...
  filteredNodeTemplates: computed('nodeWhich','model.nodeTemplate.@each.{state,driver}', function() {
    const driver = get(this, 'nodeWhich');
    return get(this, 'model.nodeDrivers').filterBy('state','active').filterBy('driver', driver);
  }),
