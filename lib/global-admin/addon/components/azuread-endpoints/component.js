  ...
  regionDidChange: observer('region', 'authConfig.tenantId', function() {
    ...
    case C.AZURE_AD.STANDARD.KEY:
      setProperties(config, {
        ...
        tokenEndpoint: `${ C.AZURE_AD.STANDARD.ENDPOINT }${ tenantId }/oauth2/v2.0/token`,
        authEndpoint:  `${ C.AZURE_AD.STANDARD.ENDPOINT }${ tenantId }/oauth2/v2.0/authorize`,
      });
      break;
    case C.AZURE_AD.CHINA.KEY:
      setProperties(config, {
        ...
        tokenEndpoint: `${ C.AZURE_AD.CHINA.ENDPOINT }${ tenantId }/oauth2/v2.0/token`,
        authEndpoint:  `${ C.AZURE_AD.CHINA.ENDPOINT }${ tenantId }/oauth2/v2.0/authorize`,
      });
      break;
