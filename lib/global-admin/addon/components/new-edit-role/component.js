...
export default Component.extend(NewOrEdit, {
  ...
  isDefault: computed('roleType', {
    get(/* key */) {
      ...
      switch (type) {
      case 'global':
        out = get(model, 'newUserDefault')
        break;
      case 'cluster':
        out = get(model, 'clusterCreatorDefault');
        break;
      case 'project':
        out = get(model, 'projectCreatorDefault');
        break;
      default:
        break;
      }
    ...
    set(key, value) {
      ...
      case 'global':
        ...
        break;
      case 'cluster':
        prop = 'clusterCreatorDefault';
        break;
      case 'project':
        prop = 'projectCreatorDefault';
        break;
      default:
        break;
      }
