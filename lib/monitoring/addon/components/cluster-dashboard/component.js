...
export default Component.extend(CatalogUpgrade, {
  ...
  hideManagerAndSchedulerStatus: computed('cluster.provider', function() {
    const provider = get(this, 'cluster.provider');

    return GRAY_OUT_SCHEDULER_STATUS_PROVIDERS.indexOf(provider) > -1;
  }),
