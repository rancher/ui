...
export default Component.extend({
  ...
  sourceCodeCredentialObserve: function(){
    let selectedRepo = this.get('selectedRepo');
    let accountsInfo = this.get('accountsInfo');
    if(!selectedRepo){
      this.set('selectedModel.sourceCodeConfig.sourceCodeCredentialId', undefined);
    }
    if(accountsInfo){
