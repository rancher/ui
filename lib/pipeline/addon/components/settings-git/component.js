...
import {
  set, get, observer, computed, setProperties
} from '@ember/object';
...
export default Component.extend({
  ...
  didReceiveAttrs() {
    ...
    if ( get(provider, 'type') === 'githubProvider' ) {
      oauthed = get(provider, 'githubConfig') || null;
      set(this, 'selectedOauthType', 'github');
    } else if ( get(provider, 'type') === 'gitlabProvider' ) {
      oauthed = get(provider, 'gitlabConfig') || null;
