...
export default Component.extend(CrudCatalog, ReservationCheck, {
  ...
  insufficientPilotCpu: computed('pilotSchedulableNodes.@each.{allocatable,requested}', 'config.pilotRequestCpu', 'scope.currentCluster.nodes.@each.{allocatable,requested}', function() {
    return this.getComponetInsufficient('pilot', 'cpu')
  }),

  insufficientPilotMemory: computed('pilotSchedulableNodes.@each.{allocatable,requested}', 'config.pilotRequestMemory', 'scope.currentCluster.nodes.@each.{allocatable,requested}', function() {
    return this.getComponetInsufficient('prometheus', 'memory')
  }),
  ...
  pilotWarning: computed('insufficientPilotCpu', 'insufficientPilotMemory', function() {
    ...
    const memory = get(this, 'config.insufficientPilotMemory')
