...
import ReuseMonitoring from 'shared/mixins/reuse-monitoring';
...
const MONITORING_CLUSTER_CPU = 900 + 750;
const MONITORING_CLUSTER_MEMORY = 970 + 750;
const ISTIO_CLUSTER_CPU = 500;
const ISTIO_CLUSTER_MEMORY = 500;

export default Component.extend(CrudCatalog, ReservationCheck, CatalogUpgrade, ReuseMonitoring, {
  scope:        service(),
  intl:         service(),
  grafana:      service(),
  ...
  actions: {
    save(cb) {
      ...
      ['gateway', 'pilot', 'mixer'].map((component) => {
