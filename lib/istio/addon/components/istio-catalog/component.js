...
const HIDDEN_KEYS = {
  ...
  'global.defaultPodDisruptionBudget.enabled':   false,
...
const ISTIO_BREAKING_VERSION = '0.1.2';
...
export default Component.extend(CrudCatalog, ReservationCheck, CatalogUpgrade, {
  ...
  kialiUrl: computed('cluster.id', 'templateVersion', function() {
    ...
    if (!isEmpty(templateVersion) && Semver.lte(templateVersion, ISTIO_BREAKING_VERSION) ) {
      kialiPort = ':20001';
    }
