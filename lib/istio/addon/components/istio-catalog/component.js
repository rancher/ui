...
const MONITRING_MIN_CPU = 650
const MONITRING_MIN_MEMORY = 650
const PROMETHEUS_DEFAULT_CPU = 750
const PROMETHEUS_DEFAULT_MEMORY = 750

const MONITORING_CLUSTER_CPU = PROMETHEUS_DEFAULT_CPU + MONITRING_MIN_CPU;
const MONITORING_CLUSTER_MEMORY = PROMETHEUS_DEFAULT_MEMORY + MONITRING_MIN_MEMORY;
