...
export default Component.extend(NodeDriver, {
  ...
  networkContent: computed('config.datacenter', 'model.cloudCredentialId', async function() {
    const options = await this.requestOptions(
      'networks',
      get(this, 'model.cloudCredentialId'),
      get(this, 'config.datacenter')
  ...
  contentLibraryContent: computed('config.datacenter', 'model.cloudCredentialId', async function() {
    const options = await this.requestOptions(
      'content-libraries',
      get(this, 'model.cloudCredentialId'),
      get(this, 'config.datacenter')
