...
export default Component.extend(NodeDriver, {
  ...
  datacenterContent: computed('config.datacenter', 'model.cloudCredentialId', async function() {
    ...
    const valueInContent = content.find((c) => c.value === get(this, 'config.datacenter') );
  ...
  tagContent: computed('config.{contentLibrary,tag}', 'model.cloudCredentialId', async function() {
  ...
  hostContent: computed('config.datacenter', 'model.cloudCredentialId', async function() {
  ...
  resourcePoolContent: computed('config.datacenter', 'model.cloudCredentialId', async function() {
    const options = await this.requestOptions(
      'resource-pools',
      get(this, 'model.cloudCredentialId'),
      get(this, 'config.datacenter')
  ...
  dataStoreContent: computed('config.datacenter', 'model.cloudCredentialId', async function() {
    const options = await this.requestOptions(
      'data-stores',
      get(this, 'model.cloudCredentialId'),
      get(this, 'config.datacenter')
  ...
  dataStoreClusterContent: computed('config.datacenter', 'model.cloudCredentialId', async function() {
    const options = await this.requestOptions(
      'data-store-clusters',
      get(this, 'model.cloudCredentialId'),
      get(this, 'config.datacenter')
  ...
  folderContent: computed('config.datacenter', 'model.cloudCredentialId', async function() {
    const options = await this.requestOptions(
      'folders',
      get(this, 'model.cloudCredentialId'),
      get(this, 'config.datacenter')
  ...
  networkContent: computed('config.{datacenter,network}', 'model.cloudCredentialId', async function() {
    const options = await this.requestOptions(
      'networks',
      get(this, 'model.cloudCredentialId'),
      get(this, 'config.datacenter')
  ...
  virtualMachineContent: computed('config.datacenter', 'model.cloudCredentialId', async function() {
    const options = await this.requestOptions(
      'virtual-machines',
      get(this, 'model.cloudCredentialId'),
      get(this, 'config.datacenter')
  ...
  templateContent: computed('config.datacenter', 'model.cloudCredentialId', async function() {
    const options = await this.requestOptions(
      'templates',
      get(this, 'model.cloudCredentialId'),
      get(this, 'config.datacenter')
  ...
  resetValueIfNecessary(key, content, options, isArray = false) {
    const isValueInContent = () => {
      if (isArray) {
        return get(this, `config.${ key }`).every((value) => content.find((c) => c.value === value));
      }

      return content.find((c) => c.value === get(this, `config.${ key }`) );
    }
