...
export default Service.extend({
  ...
  securityScanConfig: computed('configMaps', 'configMaps.[]',  function() {
    return get(this, 'configMaps').findBy('id', 'security-scan:security-scan-cfg');
  }),

  parsedSecurityScanConfig: computed('defaultValue', 'loadedTrigger', 'securityScanConfig.data.[]', function() {
    try {
  ...
  skipList: computed('report.version', 'securityScanConfig.data.[]', function() {
    const defaultValue = [];
