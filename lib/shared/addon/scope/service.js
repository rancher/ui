...
export default Service.extend({
  ...
  startSwitchToGlobal() {
    ...
    return this._startSwitchTo(null,null);
  },
  ...
  startSwitchToCluster(cluster) {
    ...
    return this._startSwitchTo(cluster, null);
  },
  ...
  startSwitchToProject(project) {
    this._setPageScope('project');
    return this._startSwitchTo(get(project,'cluster'), project);
  },
  ...
  _startSwitchTo(cluster, project) {
