...
export default Component.extend({
  ...
  harvesterCloudProviderDisabled: computed('cluster.name', 'model.harvesterNodeTemplateId', function() {
    return !get(this, 'model.harvesterNodeTemplateId') || !get(this, 'cluster.name')
  }),
