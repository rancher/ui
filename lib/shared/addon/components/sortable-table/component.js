...
export default Component.extend(Sortable, StickyHeader, {
  ...
  init() {
    ...
    defineProperty(this, 'groupedContent', computed(watchKey, 'groupByKey', 'groupByRef', 'pagedContent', 'selectedNodes', () => {
      let ary = [];
      let map = {};
  ...
  filtered: computed('arranged.[]', 'searchFields', 'searchText', 'subFields', 'subSearchField', function() {
  ...
  pageCountContent: computed('filtered.length', 'indexFrom', 'indexTo', 'pagedContent.totalPages', function() {
