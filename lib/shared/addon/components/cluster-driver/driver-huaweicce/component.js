...
export default Component.extend(ClusterDriver, {
  ...
  editedVpcName: computed('config.vpcId', 'vpcs', function() {
    const vpcId = get(this, 'config.vpcId')
    const vpcs = get(this, 'vpcs') || []
  ...
  editedSubnetName: computed('config.subnetId', 'subnets', function() {
  ...
  clusterEipName: computed('config.clusterEipId', 'eipIds', function() {
    const eipIds = get(this, 'eipIds') || []
  ...
  editedSshName: computed('config.sshKey', 'keypairs', function() {
  ...
  managementScaleDisplay: computed('managementScale', 'managementScaleContent', function() {
  ...
  networkContent: computed('config.projectId', 'networks.[]', 'publicCloud', function() {
    const networks = get(this, 'networks')
    const publicCloud = get(this, 'publicCloud')
    let arr = []
