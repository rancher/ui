...
export default Component.extend(ClusterDriver, {
  ...
  subnetChoices: computed('allSubnets', 'config.vpcId', 'selectedZone.label', 'vpcChoices.[]', function() {
    if ( !get(this, 'selectedZone') || !get(this, 'allSubnets') ) {
      return;
    }
    const subnets = get(this, 'allSubnets').filter((subnet) => get(subnet, 'vpcId') === get(this, 'config.vpcId') && get(subnet, 'zone') === get(this, 'selectedZone.label'));
  ...
  instanceChoices: computed('allInstances', 'config.instanceType', 'selectedZone.label', function() {
