...
export default Component.extend(ClusterDriver, {
  ...
  ipPolicyCreateSubnetworkChange: observer('config.ipPolicyCreateSubnetwork', function() {
    if (get(this, 'config.ipPolicyCreateSubnetwork')) {
      setProperties(this, {
        'config.ipPolicyClusterSecondaryRangeName':  '',
        'config.ipPolicyServicesSecondaryRangeName': '',
      })
    }
  }),
