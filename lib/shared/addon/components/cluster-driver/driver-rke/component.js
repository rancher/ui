...
export default Component.extend(ClusterDriver, {
  ...
  driverDidChange: observer('nodeWhich', function () {
    ...
    if ( driver=== 'amazonec2' ) {
      ...
      const nue = get(this, 'globalStore').createRecord({ type: 'azureCloudProvider' });
      delete nue.type;
      this.checkDefaults(nue);
      set(config, 'cloudProvider.azureCloudProvider', nue);
    } else if ( get(config, 'cloudProvider') ){
