...
export default Component.extend(ClusterDriver, {
  ...
  disableVersionSelect: computed('config.kubernetesVersion', '', function() {
  ...
  nodeGroupsVersionCollection: computed('config.nodeGroups.@.each{version}', function() {
    return (get(this, 'config.nodeGroups') || []).map((ng) => ng.version).uniq();
  }),

  versionChoices: computed('kubernetesVersionContent', 'nodeGroupsVersionCollection.[]', function() {
    const {
      config,
      intl,
