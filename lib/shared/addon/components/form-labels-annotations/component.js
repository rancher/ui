...
export default Component.extend(ManageLabels, {
  ...
  initLabelsAndAnnotations() {
    ...
    const initialLabelsKeys = Object.keys((get(this, 'initialLabels') || {}));

    initialLabelsKeys.forEach((key) => {
    ...
    function isReadonlyLabel(labelKey) {
      return C.LABEL_PREFIX_TO_IGNORE.find((L) => {
        return labelKey !== C.LABEL_CATTLE_CLUSTER_AGENT && labelKey.startsWith(L);
      });
    }
  },
