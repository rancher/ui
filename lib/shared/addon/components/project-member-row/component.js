...
export default Component.extend({
  ...
  kind: computed('owner.type','member.role.subjectKind', function () {
    // vjf: I dunno what this is suppose to do but it doesn't work, member has a subjectKind on edit but not new...
    return 'projectsPage.new.form.members.user';
    //if (get(this, 'owner')) {
