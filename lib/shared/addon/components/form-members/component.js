      ...
      set(this, 'memberArray', bindings.forEach((b) => {
        ...
        if (match) {
          ...
          match = {
            ...
            principalId: get(b, 'userPrincipalId'),
          ...
          bindings.forEach((memberBinding) => {
            if (!preEditBindings.findBy('roleTemplateId', memberBinding)) {
              if (get(member, 'memberId')) {
                ...
                if (type) {
                  if (type === 'group') {
                    add.push(this.createRole({groupPrincipalId: memberId, roleTemplateId: memberBinding}));
                  } else {
                    add.push(this.createRole({userPrincipalId: memberId, roleTemplateId: memberBinding}));
                  }
                } else {
                  add.push(this.createRole({userPrincipalId: memberId, roleTemplateId: memberBinding}));
                }
