...
export default Component.extend({
  ...
  init() {
    ...
    const namespaceSecrets = get(this, 'store').all('namespacedSecret').content || []
    const namespaceSecretsFilter = namespaceSecrets.filter((n) => n.type === 'namespacedSecret' || n.type === 'namespacedServiceAccountToken')

    set(this, 'namespaceSecrets', namespaceSecretsFilter);
