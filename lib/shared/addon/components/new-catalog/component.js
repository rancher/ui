...
export default Component.extend(NewOrEdit, {
  ...
  validate() {
    ...
    if (!get(this, 'editing') && !get(this, 'namespaceResource.name')) {
  ...
  didSave(neu) {
    ...
    let version = get(this, 'selectedTemplateUrl');
    return get(this, 'catalog').fetchByUrl(version).then((v) => {

      setProperties(app, {
        externId: get(v, 'externalId'),
