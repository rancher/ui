...
export default Component.extend({
  ...
  getCpuGauge() {
    return this.getGauge('cpu', n => n.allocatable.cpu * 1000, n => n.requested.cpu.substr(0, n.requested.cpu.length - 1));
  },

  getMemoryGauge() {
    return this.getGauge('memory',
      n => n.allocatable.memory.substr(0, n.allocatable.memory.length - 2),
      n => n.requested.memory,
      v => formatSi(v, 1024, 'B', 'B', 1),
      v => formatSi(v, 1024, 'B', 'B', 1));
  },

  getPodsGauge() {
    return this.getGauge('pods', n => n.allocatable.pods, n => n.requested.pods);
  },
