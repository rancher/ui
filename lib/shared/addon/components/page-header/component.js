...
export default Component.extend(HoverDropdown, {
  ...
  clusterId            : computed.alias('projects.currentCluster.id'),
  cluster              : computed.alias('projects.currentCluster'),
  projectId            : computed.alias('projects.current.id'),
  project              : computed.alias('projects.current'),
  isAdmin              : computed.alias('access.admin'),
  isCaas               : computed.equal('app.mode',C.MODE.CAAS),
  isOss                : computed.equal('app.mode',C.MODE.OSS),
  accessEnabled        : computed.alias('access.enabled'),
