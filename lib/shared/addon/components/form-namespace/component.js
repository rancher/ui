...
export default Component.extend({
  ...
  init() {
    ...
    set(this, 'choices', get(this, 'clusterStore').all('namespace')
      .filterBy('projectId', get(this, 'scope.currentProject.id'))
      .sortBy('displayName'));
    ...
    this.sendAction('registerHook', this.saveNamespace.bind(this), {
