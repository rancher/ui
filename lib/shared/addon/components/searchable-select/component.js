...
export default Component.extend({
  ...
  displayLabel: computed('interContent.[]', 'intl.locale.[]', 'localizedHtmlLabel', 'localizedLabel', 'optionLabelPath', 'optionValuePath', 'prompt', 'value', function() {
    const value = get(this, 'value');
  ...
  filtered: computed('allowCustom', 'clientSideFiltering', 'filter', 'interContent.[]', 'optionGroupPath', 'optionLabelPath', function() {
  ...
  unGroupedContent: computed('filtered.[]', 'optionGroupPath', function() {
  ...
  groupedContent: computed('filtered.[]', 'optionGroupPath', function() {
    const groupPath = get(this, 'optionGroupPath');
    const out       = [];
