...
export default Component.extend({
  ...
  init() {
    ...
    (get(this, 'initialValues') || []).forEach((value) => {
      const v = get(this, 'content.firstValue.value') || value;
  ...
  actions: {
    add() {
      get(this, 'ary').pushObject(EmberObject.create({ value: get(this, 'content.firstValue.value') || get(this, 'defaultValue') }));
      next(() => {
