...
const defaultStateMap = {
  ...
  'locked':                   {icon: 'icon icon-adjust',        color: 'text-warning'  },
  ...
  'succeeded':                {icon: 'icon icon-dot-circlefill',color: 'text-success'  },
...
export default Mixin.create({
  ...
  _availableActions: computed('availableActions.[]', 'links.{self,yaml}', 'canEdit', 'canEditYaml', 'canViewYaml', 'canRemove', function() {
  ...
  canViewYaml: computed('links.yaml', 'canEditYaml', function() {
  ...
  actions: {
    promptDelete() {
      get(this,'modalService').toggleModal('confirm-delete', {escToClose: true, resources: [this]});
    },
    ...
    editYaml(){
      get(this,'modalService').toggleModal('modal-yaml', {escToClose: true, resource: this});
    },

    viewYaml(){
      get(this,'modalService').toggleModal('modal-yaml', {escToClose: true, resource: this, readOnly: true});
    },
