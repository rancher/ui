...
export default Mixin.create({
  ...
  didReceiveAttrs() {
    ...
    if (get(this, 'volume.type') === 'volume') {
      schema = get(this, 'store').getById('schema', typeName);
    } else {
      schema = get(this, 'clusterStore').getById('schema', typeName);
    }
  ...
  getTypeName: function () {
    const plugin = get(this, 'plugin');
    if (get(this, 'volume.type') === 'volume') {
      return get(this, 'store').getById('schema', 'volume').resourceFields[plugin].type.toLocaleLowerCase();
    } else {
