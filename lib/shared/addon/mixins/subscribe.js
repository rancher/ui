...
export default Mixin.create({
  ...
  init() {
    ...
    socket.on('message', (event) => {
      schedule('actions', this, function() {
        ...
        var currentProject = get(this,'scope.currentProject.id');
  ...
  forStr() {
    ...
    var projectId = get(this,`cookies.${C.COOKIE.PROJECT}`);
    if ( socket )
    {
...
//@TODO-2.0      get(this,'growl').error(intl.t('growl.webSocket.connecting.title'), intl.t('growl.webSocket.connecting.disconnectedWarning'));
      ...
      set(this,'disconnectedTimer', later(this, function() {
