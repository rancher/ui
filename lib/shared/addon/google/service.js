...
export default Service.extend({
  ...
  imageTypesV2: [
    ...
    },
    {
      ...
      value:       'WINDOWS_LTSC',
      k8sVersion:  '< 1.24',
      replaceWith: 'WINDOWS_LTSC_CONTAINERD',
    },
    {
      label:       'clusterNew.googlegke.imageTypeV2.WINDOWS_SAC',
      value:       'WINDOWS_SAC',
      k8sVersion:  '< 1.24',
      replaceWith: 'WINDOWS_SAC_CONTAINERD',
    },
    {
      label:       'clusterNew.googlegke.imageTypeV2.WINDOWS_LTSC_CONTAINERD',
      value:       'WINDOWS_LTSC_CONTAINERD',
      k8sVersion:  '>= 1.21',
      replaceWith: 'WINDOWS_LTSC',
    },
    {
      label:       'clusterNew.googlegke.imageTypeV2.WINDOWS_SAC_CONTAINERD',
      value:       'WINDOWS_SAC_CONTAINERD',
      k8sVersion:  '>= 1.21',
      replaceWith: 'WINDOWS_SAC',
    },
  ],
  diskTypes: [
    {
